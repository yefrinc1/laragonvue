        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form @submit.prevent="(op === '1' ? save() : update())">
                        ...
                        <div class="input-group mb-3">
                            ...
                            name="title" v-model="form.title" maxlength="120" placeholder="Canción" required>
                            </TextInput>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            name="autor" v-model="form.autor" maxlength="120" placeholder="Autor" required>
                            </TextInput>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            name="album" v-model="form.album" maxlength="80" placeholder="Album" required>
                            </TextInput>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-dark" :id="'cerrar' + op"
